...
void MainWindow::pause() {
	...
	pausewindow->setGeometry(0, 220, 725, 725);
   ...
   // layout->addWidget(pausebutton);
	...
	pausebutton->setIconSize(QSize(725, 725));
	pausebutton->setGeometry(0, 0 ,725, 725);
    pausebutton->setFlat(true);
    pausewindow->show();

    QWidget *blockwindow = new QWidget(this, Qt::FramelessWindowHint);
	blockwindow->setGeometry(0, 0, 725, 220);
...
void MainWindow::success() {
	...
	successwindow->setGeometry(0, 220, 725, 725);
   ...
   // layout->addWidget(successbutton);
	...
	successbutton->setIconSize(QSize(725, 725));
	successbutton->setGeometry(0, 0 ,725, 725);
...
void MainWindow::failed() {
	...
	failedwindow->setGeometry(0, 220, 725, 725);
	...
	failedbutton->setIconSize(QSize(725, 725));
	failedbutton->setGeometry(0, 0, 725, 725);
