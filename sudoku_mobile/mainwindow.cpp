...
void MainWindow::pause() {
	...
	pausewindow->setGeometry(0, 220, 1080, 1080);
    pausewindow->setObjectName("pausewindow");
	pausewindow->setStyleSheet("#pausewindow {background-color:rgba(255,255,255,120);}");
   ...
   // layout->addWidget(pausebutton);
	...
	pausebutton->setIconSize(QSize(1080, 1080));
	pausebutton->setGeometry(0, 0 ,1080, 1080);
    pausebutton->setFlat(true);
    pausewindow->show();

    QWidget *blockwindow = new QWidget(this, Qt::FramelessWindowHint);
	blockwindow->setGeometry(0, 0, 1080, 220);
...
void MainWindow::success() {
	...
	successwindow->setGeometry(0, 220, 1080, 1080);
   ...
   // layout->addWidget(successbutton);
	...
	successbutton->setIconSize(QSize(1080, 1080));
	successbutton->setGeometry(0, 0 ,1080, 1080);
...
void MainWindow::failed() {
	...
	failedwindow->setGeometry(0, 220, 1080, 1080);
	...
	failedbutton->setIconSize(QSize(1080, 1080));
	failedbutton->setGeometry(0, 0, 1080, 1080);
